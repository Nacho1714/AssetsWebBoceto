...
// Graficos
import { CustomBarVertical, CustomLine, CustomBar } from "../../../component/chart";

// Data
import { ChartOfPlacedOrders, MonthlyOrderChart, WeeklyOrderChart } from "../../../data/chart/graphicHomeData";

export default function OrderComposition() {
    return (
        <Grid container size={{ md: 1 }} columns={{ md: 3 }} spacing={2}>
